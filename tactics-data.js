  ...
  utilityTypes: [
    {
      ...
      durationSeconds: 18,
      coverageUnits: 144,
      coverageLabel: '约 144u 半径 · 288u 直径',
      trigger: '落地后生成烟云',
    ...
    },
    {
      ...
      duration: '最长约 5 秒致盲',
      durationSeconds: 5,
      timelineWindowSeconds: 6,
      timelineStartSeconds: 1.5,
      coverageUnits: 300,
      coverageLabel: '约 300u 方向提示 · 实际随视角 / 遮挡变化',
      trigger: '约 1.5 秒后爆炸',
    ...
    },
    {
      ...
      durationSeconds: 1.5,
      timelineStartSeconds: 1.5,
      timelineWindowSeconds: 1,
      coverageUnits: 350,
      coverageLabel: '350u 爆炸范围 · 按 Valve 的 m_flRange',
      trigger: '约 1.5 秒后爆炸',
    ...
    },
    {
      ...
      coverageUnits: { T: 150, CT: 150 },
      coverageLabel: '150u 最大扩散距离 · 实际按地面与火焰网格扩散',
      trigger: '接触地面后点燃',
