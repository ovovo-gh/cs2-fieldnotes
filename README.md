...
“关键投掷办法”区分内置资料和“我的投掷卡”：支持按关键词 / 道具搜索、新增、编辑、删除。自定义卡新增时只需先后点击地图上的投掷点和落点，坐标自动记录，不需要手填数字；还可以填写投掷步骤、来源、点位截图和演示视频地址，截图会直接显示在卡片内，视频也能直接播放。页面按地图整理了小黑盒公开检索入口，用于发现点位和截图；社区帖子不是版本锁定数据，加入自己的固定方案前请在当前 CS2 练习房复核。
