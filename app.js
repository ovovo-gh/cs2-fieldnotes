(() => {
  ...
  function render({preserveScroll=false}={}){
    ...
    if(route!=='tactics'){if(tacticsTimeline.running)stopTacticsTimeline();tacticsPlacementMode=false;}
  ...
  document.addEventListener('click',e=>{
    const board=e.target.closest?.('#tactic-map-canvas');if(board&&tacticsPlacementMode){addTacticThrow(e,board);return;}
