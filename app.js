  ...
  document.addEventListener('change',async e=>{
    ...
    if(t.id==='import-data'){
      ...
      try{
        ...
        state={version:1,days:{...state.days,...imported.days},read:[...new Set([...state.read,...imported.read])],bookmarks:[...new Set([...state.bookmarks,...imported.bookmarks])],checks:{...state.checks,...imported.checks},weeks:[...new Set([...state.weeks,...imported.weeks])],logs:[...logs.values()],lastChapter:imported.lastChapter,sensitivity:{active:imported.sensitivity.active,profiles:{rifle:{...state.sensitivity.profiles.rifle,...imported.sensitivity.profiles.rifle,tests:mergeById(state.sensitivity.profiles.rifle.tests,imported.sensitivity.profiles.rifle.tests,500)},sniper:{...state.sensitivity.profiles.sniper,...imported.sensitivity.profiles.sniper,tests:mergeById(state.sensitivity.profiles.sniper.tests,imported.sensitivity.profiles.sniper.tests,500)}}},recoil:{sessions:mergeById(state.recoil.sessions,imported.recoil.sessions,2000)}};
